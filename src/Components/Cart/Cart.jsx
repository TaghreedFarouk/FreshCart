        ...
        {isCartEmpty ? (
          ...
          <div className="overflow-y-auto h-[calc(100%-4rem)] p-4">
            ...
            <div className="flex items-center justify-center gap-3">
              <button onClick={()=>{navigation('cart')}} className="bg-green-500  p-2  dark:bg-green-800 dark:border-green-500 dark:text-white text-center rounded mt-5 hover:text-white hover:bg-gray-800 dark:hover:text-gray-800 dark:hover:bg-green-500 transition-all duration-700">
                View Cart
              </button>
              <button onClick={()=>{navigation('checkout/'+cartProducts?._id)}}  className="bg-red-800 p-2 text-white dark:bg-red-600 dark:text-gray-800 text-center rounded mt-5 hover:text-gray-800 hover:border-2 hover:border-gray-800 hover:bg-white dark:hover:text-white dark:hover:border-white dark:hover:bg-red-500 transition-all duration-700">
                Check Out 
              </button>
            </div>
          </div>
