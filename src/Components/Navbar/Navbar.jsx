...
export default function Navbar() {
  ...
  return (
    <header className="bg-gray-100 dark:bg-gray-800 sticky top-0 z-50">
        ...
        <div className="flex items-center justify-between gap-5 md:gap-0 flex-row">  
          <div className="flex items-center">
            <div className="text-gray-800 dark:text-white font-bold text-sm xl:text-lg">
              <Link to={'/'}><i className="fa-solid fa-cart-plus text-green-400n"></i> FreshCart</Link>
            </div>
            {userToken && (
              <ul className="hidden md:flex items-center space-x-8 md:space-x-3 ms-10">
                <li><NavLink to={'/'} className="text-gray-800 block text-[15px] xl:text-lg dark:text-white" activeClassName="font-semibold">Home</NavLink></li>
                 
          
                  <li><NavLink to={'/categories'} className="text-gray-800  text-[15px] xl:text-lg dark:text-white" activeClassName="font-semibold">Categories</NavLink></li>

                <li><NavLink to={'/products'} className="text-gray-800  text-[15px] xl:text-lg dark:text-white" activeClassName="font-semibold">Products</NavLink></li>
                <li><NavLink to={'/brandslider'} className="text-gray-800 text-[15px] xl:text-lg dark:text-white" activeClassName="font-semibold">Brands</NavLink></li>
