  ...
  return (
    <main className="py-5 dark:bg-gray-950">
      <div className="container mx-auto">
          ...
          <div className="mt-6 lg:mt-0 lg:px-2 w-full">
            <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
              {products?.map(product => (
                <div key={product._id} className="mx-auto mt-6 relative p-4 w-full max-w-sm transform overflow-hidden rounded-lg bg-white dark:bg-slate-800 shadow-md duration-300 hover:scale-105 hover:shadow-green-500 hover:shadow-lg">
                  ...
                  <button onClick={() => addProductToCart(product._id)} className="flex items-center justify-center w-full px-2 py-2 mt-4 font-medium tracking-wide text-white dark:text-green-800 capitalize transition-colors duration-200 transform dark:bg-white bg-green-500 rounded-md hover:bg-green-800 focus:outline-none focus:bg-green-700">
        ...
        {currentUrl === '/' ?  (
          <button className="bg-green-500 text-white p-3 my-10 block rounded w-40 mx-auto hover:text-gray-500 hover:bg-white hover:border-2 hover:border-gray-500 transition duration-500">
