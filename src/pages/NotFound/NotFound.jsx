...
export default function NotFound() {
  return (
    <>
      <div className="h-screen py-24 md:py-24 bg-gray-100 dark:bg-gray-950 flex flex-col md:flex-row items-center justify-center px-4 md:px-8">
  <div className="max-w-lg text-center md:text-left">
    <div className="text-6xl md:text-7xl font-dark font-bold dark:text-white">404</div>
    <p className="text-xl md:text-2xl font-light leading-normal mt-4 md:mt-6 dark:text-white">
      Sorry, we couldn't find this page.
    </p>
    <p className="mt-4 mb-8 text-sm md:text-base dark:text-white">
      But don't worry, you can find plenty of other things on our homepage.
    </p>
    <button className="px-4 py-2 text-sm font-medium leading-5 shadow dark:bg-white dark:text-gray-800 text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-gray-900 active:bg-gray-900 hover:bg-gray-700">
